...
urlpatterns = [
    ...
    path('changepassword/', auth_views.PasswordChangeView.as_view(template_name = "Shop/changepassword.html", form_class = ChangePasswordFrom,  success_url='/passwordchangedone/'), name='changepassword'),
    path('changepassworddone', auth_views.PasswordChangeView.as_view(template_name="Shop/changepasswordDone.html"), name='passwordchangedone'),
